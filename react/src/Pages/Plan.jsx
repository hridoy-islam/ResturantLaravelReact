    ...
    return (
        <div>
            ...
            <div className="py-20">
                ...
                <p className="mt-6 text-xl leading-8 text-gray-600 text-center">Choose the meal plan that’s right for you</p>
            </div>
            <div className="grid grid-cols-3 gap-4 container mx-auto text-center py-20">
