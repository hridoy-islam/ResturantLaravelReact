            ...
            <div className="bg-primary text-white">
                ...
                >
                    <div className="mx-auto text-center">
                        ...
                        <p className="text-xl leading-8 text-gray-600 my-4 text-white">Our Mission is to make each individual healthier by providing customized meal plans delivered to the doorsteps. We ensure your meals are prepared keeping in mind your eating habits, portion size, calorie requirements, allergies, and other preferences.</p>
                    </div>
                    ...
                    <div className="mt-8 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
                        ...
                        >
                            ...
                            <p className="text-xl leading-8 text-gray-600 my-4 text-white">
