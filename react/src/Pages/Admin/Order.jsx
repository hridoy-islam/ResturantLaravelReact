        ...
        <div>
            ...
            <div className="py-4 container mx-auto">
                <div className="flex items-center justify-between rounded-lg py-3 px-4 bg-gray-100 mt-6">
                    ...
                    <div className="form-control search-order">
                        <input
                            type="text"
                ...
                <table className="table table-xs">
                    <thead>
                        <tr>
                            ...
                            <th className='text-lg font-bold'>Create Date</th>
                    ...
                    <tbody>
                        {orders.filter((item) => {
                            ...
                            return search.toLocaleLowerCase() === ""
                                ? item
                                : item?.createdAt.toLocaleLowerCase().includes(search);
                        })
                            .map((item, index) => <tr className='my-2' key={index}>
                                ...
                                <td className='text-lg font-normal'>{item.createdAt.slice(0,10)}</td>
