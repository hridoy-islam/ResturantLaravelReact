                    ...
                    <div className="mx-auto max-w-2xl py-20 sm:py-48 lg:py-20">
                        ...
                        <div className="text-left">
                            ...
                            <div className="mt-10 flex items-center justify-start gap-x-6">
                                <a
                                    href="#"
                                    className="rounded-full flex items-center justify-around bg-primary px-6 py-3 text-md font-semibold text-white shadow-sm hover:bg-secondary focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                                >
