    ...
    return(
        <div className="lg:flex lg:flex-row flex flex-col-reverse container mx-auto">
                <div className="lg:w-5/12 w-10/12 grid grid-cols-1 mx-auto lg:mr-6 ">
                    <div
                            className="relative overflow-hidden rounded-xl transition lg:shadow-xl md:shadow-xl sm:shadow-lg shadow-lg mb-6 mt-6 lg:mt-2 shadow-[#2b34407a] flex justify-between"
                            >
                    ...
                    <div
                            className="relative overflow-hidden rounded-xl transition lg:shadow-xl md:shadow-xl sm:shadow-lg shadow-lg mb-6  lg:mt-6 shadow-[#2b34407a] flex justify-between"
                            >
                            <div className="lg:w-7/12 sm:w-7/12 lg:mr-0 mr-2">
