...
const OrderInfo = () => {
    const { setOrder, setFirstName, firstName, lastName, setLastName, setEmail, phone, setPhone, dob, setDob, country, setCountry, email, user } = useContext(userContext)
        ...
        <div className="container mx-auto  bg-white mb-12 py-12 rounded-xl">
            <div className=" px-10  rounded-xl">
                ...
                </div>
                {
                    user.email ? '' : <div>
                        <label>
                            <input type="checkbox" name="" id="" /> Create an account? Or <Link to='/login'>Login</Link></label>
                    </div>
                }
