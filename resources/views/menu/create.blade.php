<x-app-layout>
    ...
    <div class="max-w-2xl mx-auto p-4 sm:p-6 lg:p-8">
        <form action="{{ route('menu.store') }}" method="put">
            @csrf
            <div>
            ...
            <div>
                ...
                <x-text-input id="calories" name="calories" type="text" class="mt-1 block w-full" required
                    autofocus />
            ...
            <div>
                ...
                <x-text-input id="protein" name="protein" type="text" class="mt-1 block w-full" required
                    autofocus />
            ...
            <div>
                ...
                <x-text-input id="carb" name="carb" type="text" class="mt-1 block w-full" required
                    autofocus />
            ...
            <div>
                ...
                <x-text-input id="fat" name="fat" type="text" class="mt-1 block w-full" required
                    autofocus />
